    ...
    function root() {
        ...
        <span class="comment">//This is triggered when index page is visited.</span>
                                ...
                                <div class="font-menu mvt-10">
                                    ...
                                    the class <code>spv\mi\windows\Routes\Home</code> will be triggered. The <code>profile</code> also works in a similar way. 
    ...
    function root($var) {
        ...
        var_dump($var); <span class="comment no-select">//['name' => 'Brown']</span>
                                ...
                                <div class="font-menu mvt-6">
                                    ...
                                    method of the current window, the <code>home/user</code> will call the <code>spv\mi\Windows\Path\To\File</code> 
                                    class.
                                    The <code>win:</code> directive specifies the <code>spv\mi\Windows</code> namespace. 
...
<div class="pre-area">
 ...
 &lt;?php
  ...
  namespace spv\mi\windows\Routes\Home;
