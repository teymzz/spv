...
use spv\mi\core\classes\Collectibles;
use spv\mi\core\classes\Collection;
use spv\mi\core\classes\Url;
use spv\mi\core\classes\DomUrl;
use spv\mi\core\classes\EInfo;
use spv\mi\core\classes\FileManager;
use spv\mi\core\classes\ModelOptimizer;
use spv\mi\core\classes\SETTER;
use spv\mi\core\classes\Spoova;
use spv\mi\core\classes\UserDB;
...
if(!function_exists('url')){
   ...
   * @return \spv\mi\core\classes\Url
   */  
  function url($url){
    $Url = new Url;
    return $Url->path($url);
